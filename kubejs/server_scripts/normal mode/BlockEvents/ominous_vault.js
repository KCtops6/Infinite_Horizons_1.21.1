BlockEvents.rightClicked('minecraft:vault', event => { 
    ...
    if (item.id !== 'minecraft:ominous_trial_key') {
        return;
    }
    ...
    const command = `setblock x y z minecraft:vault[ominous=true]{config:{key_item:{count:1,id:"minecraft:ominous_trial_key"},loot_table:"minecraft:chests/trial_chambers/reward_ominous"} replace`;
