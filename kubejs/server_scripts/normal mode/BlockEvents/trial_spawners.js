BlockEvents.rightClicked('minecraft:copper_grate', event => { 
    ...
    // Run the /setblock command
    const command = `setblock ${x} ${y} ${z} trial_spawner[ominous=false,trial_spawner_state=active]{normal_config:{spawn_potentials:[{data:{entity:{id:"minecraft:${trialName}"}},weight:1}]},target_cooldown_length:6000} replace`;
