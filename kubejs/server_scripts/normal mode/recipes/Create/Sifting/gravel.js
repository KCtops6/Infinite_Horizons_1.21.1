//ignored: false
function ironMultiplier(x) { return x * 1.2 }
function brassMultiplier(x) { return ironMultiplier(x) * 1.4 }
function netheriteMultiplier(x) { return brassMultiplier(x) * 1.6 }
